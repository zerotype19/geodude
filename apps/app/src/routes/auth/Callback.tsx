...
export default function Callback() {
  useEffect(() => {
    // The Worker will redirect after verification
    // This is just a loading state while the redirect happens
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
        ...
        <p className="text-sm text-gray-600">Please wait while we verify your link.</p>
