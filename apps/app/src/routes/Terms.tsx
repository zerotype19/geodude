    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-3">2. Purpose of the Service</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-3">3. Informational Nature of Results</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-3">4. No Warranties or Guarantees</h2>
            <p className="text-gray-700 leading-relaxed mb-3">
            ...
            <p className="text-gray-700 leading-relaxed mb-3">We do <strong>not warrant or guarantee</strong> that:</p>
            <ul className="list-disc ml-6 space-y-2 text-gray-700">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-3">6. No Endorsement or Affiliation</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-3">7. Data Accuracy and Availability</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-3">8. User Responsibilities</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-3">10. Changes to These Terms</h2>
            <p className="text-gray-700 leading-relaxed">
