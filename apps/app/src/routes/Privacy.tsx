        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              <a href="mailto:privacy@optiview.ai" className="text-blue-600 hover:underline">privacy@optiview.ai</a>.
            </p>
            <p className="text-gray-700 leading-relaxed mt-3">Backups are purged on a scheduled basis.</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-3">5. Sharing and Disclosure</h2>
            <p className="text-gray-700 leading-relaxed mb-3">We only share data:</p>
            <ul className="list-disc ml-6 space-y-2 text-gray-700">
              <li>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-3">6. Security</h2>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-3">8. Updates</h2>
            <p className="text-gray-700 leading-relaxed">
