...
export default function Sources() {
    ...
    async function loadSources() {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const normalizedSources = (sourcesArray || []).map((source) => ({
                    id: source.id,
    ...
    return (_jsxs(Shell, { children: [_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "flex justify-between items-start", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold text-slate-900", children: "AI Sources" }), _jsxs("p", { className: "text-slate-600 mt-2", children: ["Manage and monitor AI platforms that reference your ", project.name, " content"] })] }), _jsx("a", { href: "/docs/sources", className: "text-blue-600 hover:text-blue-800 underline text-sm", children: "Docs \u2192" })] }), _jsxs("div", { className: "flex justify-between items-center mb-6", children: [_jsx("div", { children: _jsx("p", { className: "text-slate-600", children: "Enable or disable AI sources to track which platforms reference your content. All sources are available globally - just toggle them on or off for this project." }) }), _jsxs("div", { className: "flex gap-3", children: [!user?.is_admin && (_jsx("button", { onClick: () => setShowSuggestModal(true), className: "px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2", children: "Suggest New Source" })), user?.is_admin && (_jsx("button", { onClick: () => setShowAdminModal(true), className: "px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2", children: "Add New Source" }))] })] }), error && (_jsx("div", { className: "bg-red-50 border border-red-200 rounded-md p-4", children: _jsxs("div", { className: "flex", children: [_jsx("div", { className: "flex-shrink-0", children: _jsx("svg", { className: "h-5 w-5 text-red-400", viewBox: "0 0 20 20", fill: "currentColor", children: _jsx("path", { fillRule: "evenodd", d: "M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z", clipRule: "evenodd" }) }) }), _jsx("div", { className: "ml-3", children: _jsx("p", { className: "text-sm text-red-800", children: error }) }), _jsx("div", { className: "ml-auto pl-3", children: _jsxs("button", { onClick: () => setError(null), className: "text-red-400 hover:text-red-600", children: [_jsx("span", { className: "sr-only", children: "Dismiss" }), _jsx("svg", { className: "h-5 w-5", viewBox: "0 0 20 20", fill: "currentColor", children: _jsx("path", { fillRule: "evenodd", d: "M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z", clipRule: "evenodd" }) })] }) })] }) })), _jsxs(Card, { title: "Available AI Sources", children: [_jsxs("div", { className: "mb-6 flex flex-wrap gap-4 items-center justify-between", children: [_jsx("div", { className: "flex items-center gap-4", children: _jsxs("div", { className: "flex items-center space-x-2", children: [_jsx("span", { className: "text-sm text-gray-600", children: "Sort by:" }), _jsxs("select", { value: sortBy, onChange: (e) => setSortBy(e.target.value), className: "text-sm border border-gray-300 rounded px-2 py-1", children: [_jsx("option", { value: "name", children: "Name" }), _jsx("option", { value: "last_seen", children: "Last Activity" }), _jsx("option", { value: "events_24h", children: "24h Events" })] }), _jsx("button", { onClick: () => setSortOrder(sortOrder === "asc" ? "desc" : "asc"), className: "text-sm text-gray-600 hover:text-gray-800", children: sortOrder === "asc" ? "↑" : "↓" })] }) }), _jsx("div", { className: "flex space-x-2", children: ["all", "enabled", "has_activity", "no_activity"].map((filterOption) => (_jsxs("button", { onClick: () => setFilter(filterOption), className: `px-3 py-1 text-xs rounded-full ${filter === filterOption
                                                ? "bg-blue-100 text-blue-800"
                                                : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`, children: [filterOption === "all" && "All Sources", filterOption === "enabled" && "Enabled Only", filterOption === "has_activity" && "With Activity", filterOption === "no_activity" && "No Activity"] }, filterOption))) })] }), loading ? (_jsx("div", { className: "space-y-3", children: [...Array(8)].map((_, i) => (_jsx("div", { className: "animate-pulse", children: _jsx("div", { className: "h-12 bg-gray-200 rounded" }) }, i))) })) : sortedSources.length === 0 ? (_jsx("div", { className: "text-center py-12", children: filter === "all" ? (_jsxs("div", { children: [_jsx("p", { className: "text-lg text-gray-900 font-medium", children: "No AI sources available" }), _jsx("p", { className: "text-gray-600 mt-1", children: "Contact your administrator to add new AI sources to the system." })] })) : (_jsxs("div", { children: [_jsx("p", { className: "text-lg text-gray-900 font-medium", children: "No sources match your filters" }), _jsx("p", { className: "text-gray-600 mt-1", children: "Try selecting \"All Sources\" to see all available options." })] })) })) : (_jsx("div", { className: "overflow-x-auto", children: _jsxs("table", { className: "w-full text-sm", children: [_jsx("thead", { children: _jsxs("tr", { className: "text-left text-slate-500 border-b", children: [_jsx("th", { className: "py-3 pr-4", children: "AI Source" }), _jsx("th", { className: "py-3 pr-4 text-center", children: "Enabled for Project" }), _jsx("th", { className: "py-3 pr-4", children: _jsx("span", { className: "cursor-help", title: "Last time this source was detected referencing your content", children: "Last Activity" }) }), _jsx("th", { className: "py-3 pr-4", children: _jsx("span", { className: "cursor-help", title: "Events from this source in the last 15 minutes", children: "15m Events" }) }), _jsx("th", { className: "py-3 pr-4", children: _jsx("span", { className: "cursor-help", title: "Events from this source in the last 24 hours", children: "24h Events" }) }), _jsx("th", { className: "py-3 pr-4", children: _jsx("span", { className: "cursor-help", title: "AI referrals detected from this source in the last 24 hours", children: "24h Referrals" }) }), _jsx("th", { className: "py-3 pr-4", children: "Actions" })] }) }), _jsx("tbody", { children: sortedSources.map((source) => (_jsxs(_Fragment, { children: [_jsxs("tr", { className: "border-b hover:bg-gray-50", children: [_jsx("td", { className: "py-3 pr-4", children: _jsxs("div", { className: "flex items-center space-x-3", children: [_jsxs("div", { children: [_jsx("div", { className: "font-medium text-gray-900", children: source.name }), _jsx("div", { className: "text-xs text-gray-500", children: source.slug })] }), _jsx("span", { className: `px-2 py-1 text-xs rounded-full ${source.category === 'chat_assistant' ? 'bg-green-100 text-green-800' :
